...
namespace Legado.Core.Data
{
    ...
    public static class DatabaseMigrations
    {
        ...
        public static async Task MigrateAsync(IFreeSql connection, int oldVersion, int newVersion)
        {
        ...
        /// 迁移到指定版本
        /// </summary>
        private static async Task MigrateToVersionAsync(IFreeSql connection, int version)
        {
            switch (version)
            {
                case 11:
        ...
        private static async Task Migration_10_11(IFreeSql connection)
        {
        ...
        private static async Task Migration_11_12(IFreeSql connection)
        {
        ...
        private static async Task Migration_12_13(IFreeSql connection)
        {
        ...
        private static async Task Migration_13_14(IFreeSql connection)
        {
            await connection.ExecuteAsync(@"
        ...
        private static async Task Migration_14_15(IFreeSql connection)
        {
        ...
        private static async Task Migration_15_17(IFreeSql connection)
        {
            await connection.ExecuteAsync(@"
        ...
        private static async Task Migration_17_18(IFreeSql connection)
        {
            await connection.ExecuteAsync(@"
        ...
        private static async Task Migration_18_19(IFreeSql connection)
        {
            // TODO: 需要实现获取设备ID的逻辑
        ...
        private static async Task Migration_19_20(IFreeSql connection)
        {
        ...
        private static async Task Migration_20_21(IFreeSql connection)
        {
        ...
        private static async Task Migration_21_22(IFreeSql connection)
        {
            await connection.ExecuteAsync(@"
                CREATE TABLE IF NOT EXISTS books_new (
                    bookUrl TEXT NOT NULL, 
        ...
        private static async Task Migration_22_23(IFreeSql connection)
        {
        ...
        private static async Task Migration_23_24(IFreeSql connection)
        {
            await connection.ExecuteAsync(@"
        ...
        private static async Task Migration_24_25(IFreeSql connection)
        {
            await connection.ExecuteAsync(@"
        ...
        private static async Task Migration_25_26(IFreeSql connection)
        {
            await connection.ExecuteAsync(@"
        ...
        private static async Task Migration_26_27(IFreeSql connection)
        {
        ...
        private static async Task Migration_27_28(IFreeSql connection)
        {
        ...
        private static async Task Migration_28_29(IFreeSql connection)
        {
        ...
        private static async Task Migration_29_30(IFreeSql connection)
        {
        ...
        private static async Task Migration_30_31(IFreeSql connection)
        {
        ...
        private static async Task Migration_31_32(IFreeSql connection)
        {
        ...
        private static async Task Migration_32_33(IFreeSql connection)
        {
        ...
        private static async Task Migration_33_34(IFreeSql connection)
        {
        ...
        private static async Task Migration_34_35(IFreeSql connection)
        {
        ...
        private static async Task Migration_35_36(IFreeSql connection)
        {
        ...
        private static async Task Migration_36_37(IFreeSql connection)
        {
        ...
        private static async Task Migration_37_38(IFreeSql connection)
        {
        ...
        private static async Task Migration_38_39(IFreeSql connection)
        {
        ...
        private static async Task Migration_39_40(IFreeSql connection)
        {
        ...
        private static async Task Migration_40_41(IFreeSql connection)
        {
        ...
        private static async Task Migration_41_42(IFreeSql connection)
        {
        ...
        private static async Task Migration_42_43(IFreeSql connection)
        {
        ...
        private static async Task Migration_54_55(IFreeSql connection)
        {
            // BookType常量定义
        ...
        /// 破坏性迁移（删除并重建所有表）
        /// </summary>
        private static async Task DestructiveMigrationAsync(IFreeSql connection)
        {
            // TODO: 实现破坏性迁移逻辑
            // 这里应该删除所有旧表并创建新表
